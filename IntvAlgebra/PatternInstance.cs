...
namespace TIRPClo
{
    ...
    public class PatternInstance
    {
        ...
        public int last;
        //Pre-matched tieps: matched === tieps of the same STI come in twice (start, finish)
        public List<STI> pre_matched;
        //Time for the expected most recent finish time
        public int ptime;
        ...
        public void extendPatternInstance(Slice s, Coincidence n)
        {
            tieps.Add(s);
            nexts.Add(n);
